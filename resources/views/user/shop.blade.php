              ...
              <div class="border-t border-gray-200 px-4 py-6">
                ...
                <div class="pt-6" id="filter-section-mobile-1">
                  <div class="space-y-6">
                    ...
                    <div class="flex items-center">
                      <input id="filter-mobile-category-2" name="category[]" value="travel" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
              ...
              <div class="border-t border-gray-200 px-4 py-6">
                ...
                <div class="pt-6" id="filter-section-mobile-2">
                  <div class="space-y-6">
                    ...
                    <div class="flex items-center">
                      <input id="filter-mobile-size-5" name="size[]" value="40l" type="checkbox"  class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
...
<h3 class="-my-3 flow-root">
    <!-- Expand/collapse section button -->
    <button type="button" class="flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500" aria-controls="filter-section-1" aria-expanded="false" onclick="toggleSection('filter-section-1')">
        <span class="font-medium text-gray-900">Category</span>
        <span class="ml-6 flex items-center" id="expandIcon">
            <!-- Expand icon, show/hide based on section open state. -->
            <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                <path id="plusIcon" d="M10.75 4.75a.75.75 0 00-1.5 0v4.5h-4.5a.75.75 0 000 1.5h4.5v4.5a.75.75 0 001.5 0v-4.5h4.5a.75.75 0 000-1.5h-4.5v-4.5z" />
            </svg>
            <!-- Collapse icon, show/hide based on section open state. -->
            <svg class="h-5 w-5 hidden" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                <path id="minusIcon"  d="M4 10a.75.75 0 01.75-.75h10.5a.75.75 0 010 1.5H4.75A.75.75 0 014 10z" clip-rule="evenodd" />
            </svg>
        </span>
    </button>
</h3>
            ...
            minusIcon.style.display = 'none';
                ...
                <div class="pt-6" id="filter-section-1">
                  <div class="space-y-4">
                    ...
                    <div class="flex items-center">
                      <input id="filter-category-2" name="category[]" value="travel" type="checkbox"  class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
              ...
              <div class="border-b border-gray-200 py-6">
                ...
                <div class="pt-6" id="filter-section-2">
                  <div class="space-y-4">
                    ...
                    <div class="flex items-center">
                      <input id="filter-size-5" name="size[]" value="40l" type="checkbox"  class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
