    ...
    <div class="py-48 h-screen ">
        <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-6xl  border">
            ...
            <div class="w-full p-8 lg:w-1/2">
                ...
                <a href="{{ route('google.login') }}" class="flex items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
                    <div class="px-4 py-3">
                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    @if ($errors->has('login'))
                        <div class="text-red-500 text-sm mb-4">{{ $errors->first('login') }}</div>
                    @endif
