...
<body>
    <div class="py-48">
        <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-6xl max-h-full border">
            ...
            <img src="{{ asset('Images/logincar.jpeg') }}" class=" md:h-[500px] w-auto h-auto">
            </div>
            <div class="w-full p-8 lg:w-1/2">
                ...
                <div class="mt-8">
                    <button class="bg-gray-700 text-white font-bold py-2 px-4 w-full rounded-full hover:bg-gray-600">Login</button>
                </div>
                <div class="mt-4 flex items-center justify-between">
