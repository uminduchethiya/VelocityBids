             ...
             <ul class="space-y-4 font-medium">
                ...
                <li class="">
                   <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 text-white hover:bg-primaryColor hover:rounded-3xl" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                         ...
                         <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Shop</span>
                   ...
                   <ul id="dropdown-example" class="hidden py-2 space-y-2">
                         <li>
                            <a href="{{route('admin.product.productlist')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 text-white hover:bg-gray-700">Product List</a>
                         </li>
                         <li>
                            <a href="{{route('admin.addproduct')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 text-white hover:bg-gray-700">Add Product</a>
                         </li>
                ...
                <li class="">
                   ...
                   <ul id="dropdown-example2" class="hidden py-2 space-y-2">
                         <li>
                            <a href="{{route('admin.categorylist')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 text-white hover:bg-gray-700">Category List</a>
                         </li>
                         <li>
                            <a href="{{route('admin.viewcategory')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 text-white hover:bg-gray-700">Add Category</a>
                         </li>
