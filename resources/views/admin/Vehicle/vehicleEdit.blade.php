...
@section('content')
    ...
    <div class="container">
        <div class="mx-10 md:mt-40">
            ...
            <p class="text-gray-600 font-boogaloo">Where our irresistible pizza offers are waiting to elevate your dining
                experience</p>
            <form action="{{route('bid.adminupdate',$vehicle->id)}}" method="post" enctype="multipart/form-data" class="flex flex-col  mx-auto md:mt-8 font-boogaloo text-[20px] mt-4">
                @method('post')
                @csrf
                ...
                <div class="flex flex-row gap-4 md:gap-8">
                    ...
                    <div class="w-7/12">
                        ...
                        <input type="text" placeholder="Vehicle Name" name="vehicle_name" value="{{$vehicle->vehicle_name}}"
                ...
                <div class="flex flex-row gap-4 md:gap-8">
                    <div class="w-7/12">
                        ...
                        <input type="text" placeholder="Registration Number" name="regnumber" value="{{$vehicle->regnumber}}"
                            class="w-full p-2 border border-gray-800 rounded-lg opacity-60">
                        {{-- Error message removed --}}
                    </div>
                    <div class="flex  w-7/12 flex-row gap-4 ">
                        <label class="">
                            ...
                            <select name="Location"
                                ...
                                <option value="Kurunagale"@if($vehicle->Location=='Kurunagale') selected @endif>Kurunagale</option>
                            </select>
                            {{-- Error message removed --}}
                        </label>
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="flex flex-wrap -mx-2">
                        <div class="w-full md:w-1/3 px-2 mb-2">
                            ...
                            <img id="preview1" class="image-preview border border-black rounded-md mt-2" src="{{ Storage::url($vehicle->image1) }}">
                        </div>
                        ...
                        <div class="w-full md:w-1/3 px-2 mb-2">
                            ...
                            <img id="preview2" class="image-preview mt-2 border border-black rounded-md" src="{{ Storage::url($vehicle->image2) }}">
                        </div>
                        ...
                        <div class="w-full md:w-1/3 px-2 mb-2">
                            ...
                            <img id="preview3" class="image-preview mt-2 border border-black rounded-md" src="{{ Storage::url($vehicle->image3) }}">
                        </div>
                        ...
                        <div class="w-full md:w-1/3 px-2 mb-2">
                            ...
                            <img id="preview4" class="image-preview mt-2 border border-black rounded-md" src="{{ Storage::url($vehicle->image4) }}">
                        </div>
                        ...
                        <div class="w-full md:w-1/3 px-2 mb-2">
                            ...
                            <img id="preview5" class="image-preview mt-2 border border-black rounded-md "src="{{ Storage::url($vehicle->image5) }}">
                        </div>
                    </div>
                </div>
    ...
    @csrf
    <button type="submit" class="items-center bg-red-800 mt-4 p-2 bg-primaryColor flex justify-start md:w-[15%] w-[150px] rounded-lg text-black md:mt-8 text-center">
        <span class="mx-auto">Update</span>
    </button>
</form>

<form method="POST" action="{{ route('bid.delete', ['vehicle' => $vehicle]) }}" onsubmit="return confirm('Are you sure you want to delete this vehicle?')">
    @csrf
    @method('DELETE')
    <button type="submit" class="items-center bg-red-800 mt-4 p-2 bg-primaryColor flex justify-start md:w-[15%] w-[150px] rounded-lg text-black md:mt-8 text-center">Delete Vehicle</button>
</form>
