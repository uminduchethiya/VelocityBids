        ...
        <div class="grid justify-center flex-1">
            <div class="flex flex-wrap flex-1 md:mt-32">
                ...
                <div class="flex-1 w-full p-4">
                    <h1 class="text-[40px] font-anton text-primaryColor md:mt-4">Welcome <span class="text-black">Umindu</span></h1>
                    <div class="">
                    ...
                    <table class="w-full text-sm table-auto font-boogaloo ">
                        ...
                        <tbody class="text-center ">
                            <tr class="text-lg hover:bg-grey-lighter">
                                <td class="px-4 py-2 border-b border-grey-light">12345</td>
                                <td class="px-4 py-2 border-b border-grey-light">2001-8-26</td>
                                <td class="px-4 py-2 border-b border-grey-light">umindu</td>
                                <td class="px-4 py-2 border-b border-grey-light">Galle</td>
                                <td class="px-4 py-2 border-b border-grey-light">debit card</td>
                                <td class="px-4 py-2 border-b border-grey-light">2000</td>
                                <td class="flex gap-2 pr-4 mt-2 px-14 ">
                                    <button
                                        class="flex items-center justify-center w-16 h-8 px-2 ml-1 text-sm text-white border rounded-lg md:block bg-green-700 ">
                                        Edit
                                    </button>
