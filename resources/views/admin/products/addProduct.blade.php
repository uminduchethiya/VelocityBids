            ...
            <form  action="{{ route('admin.product.addproduct') }}" method="post" enctype="multipart/form-data"
                ...
                <div class="flex flex-row gap-4 md:gap-8 md:mt-4">
                    ...
                    <div class="w-7/12">
                        ...
                        <input name="selling_price" id="selling_price" type="number" placeholder="Selling Price"
                            class="w-full p-2 border border-gray-800 rounded-lg opacity-60">
                    </div>
                </div>
                <div class="w-full md:mt-4">
                    <label for="">Short Description</label>
                    <input name="short_des" type="text" placeholder="Short Description"
                        class="w-full p-2 border border-gray-800 rounded-lg opacity-60">
                </div>
                <div class="flex flex-col mt-4 md:mt-8">
                    <label for="">Description</label>
                    <input name="description" placeholder="Your Message"
                ...
                <button type="submit"
                    ...
                    <span class="mx-auto">Add Product</span>
                </button>
            </form>
